...
A high-performance, thread-safe asynchronous pending request manager for .NET.
...
一款高性能、线程安全的 .NET 异步待处理请求管理器。

专为请求-响应工作流、RPC 系统、网络协议、套接字通信、进程间通信 (IPC)、游戏服务器、消息总线、异步关联 ID 以及任何需要通过匹配键来完成请求的场景而设计。